    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b>  123 United States</p> </div>
          ...
          <Link to='https://facebook.com' target='_blank' className='gap-3' id='footer-link'>
          <BsFacebook />
          </Link>
          <Link to='https://app.slack.com' id='footer-link' target='_blank' className='gap-3'>
          <BsSlack />
          </Link>
          </div>
        </div>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by Hoang Tran Developers 2023</p>
        </div>
        <div className="col-12 col-md-6">
